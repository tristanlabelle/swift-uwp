...
public final class WindowsUIXamlControlsPrimitives_JumpListItemBackgroundConverter: WindowsRuntime.WinRTImport<WindowsUIXamlControlsPrimitives_JumpListItemBackgroundConverterProjection>, WindowsUIXamlData_IValueConverterProtocol {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsUIXamlControlsPrimitives_JumpListItemBackgroundConverterProjection.self))
    }

    // MARK: Windows.UI.Xaml.Controls.Primitives.IJumpListItemBackgroundConverter members

    /// Gets or sets the brush to be used for the background when the group is empty and the jump list item is disabled.
    /// - Returns: The brush to be used for the background when the group is empty and the jump list item is disabled.
    ...
    /// - Returns: The brush to be used for the background when the group is not empty and the jump list item is enabled.
    ...
    // MARK: Windows.UI.Xaml.Controls.Primitives.IJumpListItemBackgroundConverterStatics members
    ...
    public static var disabledProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_ijumpListItemBackgroundConverterStatics.get_DisabledProperty())
        }
    }
    ...
    public static var enabledProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_ijumpListItemBackgroundConverterStatics.get_EnabledProperty())
        }
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Controls.Primitives.JumpListItemBackgroundConverter", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }

    private static var _ijumpListItemBackgroundConverterStatics_storage: COM.COMInterop<CWinRT.SWRT_WindowsUIXamlControlsPrimitives_IJumpListItemBackgroundConverterStatics>? = nil

    internal static var _ijumpListItemBackgroundConverterStatics: COM.COMInterop<CWinRT.SWRT_WindowsUIXamlControlsPrimitives_IJumpListItemBackgroundConverterStatics> {
        get throws {
            try _ijumpListItemBackgroundConverterStatics_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Controls.Primitives.JumpListItemBackgroundConverter", id: CWinRT.SWRT_WindowsUIXamlControlsPrimitives_IJumpListItemBackgroundConverterStatics.iid)
            }
        }
    }
}