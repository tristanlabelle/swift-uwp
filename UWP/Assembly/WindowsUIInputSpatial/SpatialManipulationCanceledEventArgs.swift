...
public final class WindowsUIInputSpatial_SpatialManipulationCanceledEventArgs: WindowsRuntime.WinRTImport<WindowsUIInputSpatial_SpatialManipulationCanceledEventArgsProjection> {
    // MARK: Windows.UI.Input.Spatial.ISpatialManipulationCanceledEventArgs members
