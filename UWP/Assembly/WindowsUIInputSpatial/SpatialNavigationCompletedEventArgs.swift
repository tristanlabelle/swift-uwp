...
public final class WindowsUIInputSpatial_SpatialNavigationCompletedEventArgs: WindowsRuntime.WinRTImport<WindowsUIInputSpatial_SpatialNavigationCompletedEventArgsProjection> {
    // MARK: Windows.UI.Input.Spatial.ISpatialNavigationCompletedEventArgs members
