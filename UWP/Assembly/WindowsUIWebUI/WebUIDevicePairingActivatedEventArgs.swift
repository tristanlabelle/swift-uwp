...
public final class WindowsUIWebUI_WebUIDevicePairingActivatedEventArgs: WindowsRuntime.WinRTImport<WindowsUIWebUI_WebUIDevicePairingActivatedEventArgsProjection>, WindowsApplicationModelActivation_IDevicePairingActivatedEventArgsProtocol, WindowsApplicationModelActivation_IActivatedEventArgsProtocol, WindowsUIWebUI_IActivatedEventArgsDeferralProtocol, WindowsApplicationModelActivation_IActivatedEventArgsWithUserProtocol {
    ...
    /// - Returns: Info about the device that triggered the operation.
