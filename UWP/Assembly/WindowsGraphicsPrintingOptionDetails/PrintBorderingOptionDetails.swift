...
public final class WindowsGraphicsPrintingOptionDetails_PrintBorderingOptionDetails: WindowsRuntime.WinRTImport<WindowsGraphicsPrintingOptionDetails_PrintBorderingOptionDetailsProjection>, WindowsGraphicsPrintingOptionDetails_IPrintOptionDetailsProtocol, WindowsGraphicsPrintingOptionDetails_IPrintItemListOptionDetailsProtocol {
    ...
    /// - Returns: The ID of the print bordering option.
    ...
    /// - Returns: The bordering option type
    ...
    /// - Returns: The print bordering option state.
    ...
    /// - Returns: The bordering option value
    ...
    /// - Parameter value: Value for the print bordering option.
    ...
    // MARK: Windows.Graphics.Printing.OptionDetails.IPrintBorderingOptionDetails members

    /// Gets or sets a description of the print bordering option.
    /// - Returns: String containing the description.
    public var description: Swift.String {
        get throws {
            try _iprintBorderingOptionDetails.get_Description()
        }
    }
    ...
    public func description(_ value: Swift.String) throws {
        try _iprintBorderingOptionDetails.put_Description(value)
    }
    ...
    public var warningText: Swift.String {
        get throws {
            try _iprintBorderingOptionDetails.get_WarningText()
        }
    }
    ...
    public func warningText(_ value: Swift.String) throws {
        try _iprintBorderingOptionDetails.put_WarningText(value)
    }
    ...
    private var _iprintBorderingOptionDetails_storage: COM.COMInterop<CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintBorderingOptionDetails>? = nil

    internal var _iprintBorderingOptionDetails: COM.COMInterop<CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintBorderingOptionDetails> {
        get throws {
            try _iprintBorderingOptionDetails_storage.lazyInit {
                try _queryInterfacePointer(CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintBorderingOptionDetails.iid).cast(to: CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintBorderingOptionDetails.self)
            }
        }
    }
    ...
    deinit {
        ...
        _iprintBorderingOptionDetails_storage?.release()
    }
}