...
public final class WindowsGraphicsPrintingOptionDetails_PrintBindingOptionDetails: WindowsRuntime.WinRTImport<WindowsGraphicsPrintingOptionDetails_PrintBindingOptionDetailsProjection>, WindowsGraphicsPrintingOptionDetails_IPrintOptionDetailsProtocol, WindowsGraphicsPrintingOptionDetails_IPrintItemListOptionDetailsProtocol {
    ...
    /// - Returns: The ID of the print binding option.
    ...
    /// - Returns: The binding option type.
    ...
    /// - Returns: The binding option state.
    ...
    /// - Returns: The binding option value.
    ...
    /// - Parameter value: Value for the print binding option.
    ...
    // MARK: Windows.Graphics.Printing.OptionDetails.IPrintBindingOptionDetails members

    /// Gets or sets the description of the print binding option.
    /// - Returns: String containing the description.
    public var description: Swift.String {
        get throws {
            try _iprintBindingOptionDetails.get_Description()
        }
    }
    ...
    public func description(_ value: Swift.String) throws {
        try _iprintBindingOptionDetails.put_Description(value)
    }
    ...
    public var warningText: Swift.String {
        get throws {
            try _iprintBindingOptionDetails.get_WarningText()
        }
    }
    ...
    public func warningText(_ value: Swift.String) throws {
        try _iprintBindingOptionDetails.put_WarningText(value)
    }
    ...
    private var _iprintBindingOptionDetails_storage: COM.COMInterop<CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintBindingOptionDetails>? = nil

    internal var _iprintBindingOptionDetails: COM.COMInterop<CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintBindingOptionDetails> {
        get throws {
            try _iprintBindingOptionDetails_storage.lazyInit {
                try _queryInterfacePointer(CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintBindingOptionDetails.iid).cast(to: CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintBindingOptionDetails.self)
            }
        }
    }
    ...
    deinit {
        ...
        _iprintBindingOptionDetails_storage?.release()
    }
}