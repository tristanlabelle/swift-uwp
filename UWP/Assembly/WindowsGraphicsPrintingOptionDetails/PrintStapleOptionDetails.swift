...
public final class WindowsGraphicsPrintingOptionDetails_PrintStapleOptionDetails: WindowsRuntime.WinRTImport<WindowsGraphicsPrintingOptionDetails_PrintStapleOptionDetailsProjection>, WindowsGraphicsPrintingOptionDetails_IPrintOptionDetailsProtocol, WindowsGraphicsPrintingOptionDetails_IPrintItemListOptionDetailsProtocol {
    ...
    /// - Returns: The ID for the stapling option.
    ...
    /// - Returns: The state of the stapling option.
    ...
    /// - Returns: The enumerated value of the stapling option.
    ...
    /// - Parameter value: Value for the staple opiton.
    ...
    // MARK: Windows.Graphics.Printing.OptionDetails.IPrintStapleOptionDetails members

    /// Gets or sets the description of the print staple option.
    /// - Returns: String containing the description.
    public var description: Swift.String {
        get throws {
            try _iprintStapleOptionDetails.get_Description()
        }
    }
    ...
    public func description(_ value: Swift.String) throws {
        try _iprintStapleOptionDetails.put_Description(value)
    }
    ...
    public var warningText: Swift.String {
        get throws {
            try _iprintStapleOptionDetails.get_WarningText()
        }
    }
    ...
    public func warningText(_ value: Swift.String) throws {
        try _iprintStapleOptionDetails.put_WarningText(value)
    }
    ...
    private var _iprintStapleOptionDetails_storage: COM.COMInterop<CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintStapleOptionDetails>? = nil

    internal var _iprintStapleOptionDetails: COM.COMInterop<CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintStapleOptionDetails> {
        get throws {
            try _iprintStapleOptionDetails_storage.lazyInit {
                try _queryInterfacePointer(CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintStapleOptionDetails.iid).cast(to: CWinRT.SWRT_WindowsGraphicsPrintingOptionDetails_IPrintStapleOptionDetails.self)
            }
        }
    }
    ...
    deinit {
        ...
        _iprintStapleOptionDetails_storage?.release()
    }
}