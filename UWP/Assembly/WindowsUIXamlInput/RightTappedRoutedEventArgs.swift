...
public final class WindowsUIXamlInput_RightTappedRoutedEventArgs: WindowsRuntime.WinRTImport<WindowsUIXamlInput_RightTappedRoutedEventArgsProjection> {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsUIXamlInput_RightTappedRoutedEventArgsProjection.self))
    }

    // MARK: Windows.UI.Xaml.Input.IRightTappedRoutedEventArgs members
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Input.RightTappedRoutedEventArgs", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}