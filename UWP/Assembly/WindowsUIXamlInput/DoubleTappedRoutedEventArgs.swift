...
public final class WindowsUIXamlInput_DoubleTappedRoutedEventArgs: WindowsRuntime.WinRTImport<WindowsUIXamlInput_DoubleTappedRoutedEventArgsProjection> {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsUIXamlInput_DoubleTappedRoutedEventArgsProjection.self))
    }

    // MARK: Windows.UI.Xaml.Input.IDoubleTappedRoutedEventArgs members
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Input.DoubleTappedRoutedEventArgs", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}