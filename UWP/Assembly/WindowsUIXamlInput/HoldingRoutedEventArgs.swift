...
public final class WindowsUIXamlInput_HoldingRoutedEventArgs: WindowsRuntime.WinRTImport<WindowsUIXamlInput_HoldingRoutedEventArgsProjection> {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsUIXamlInput_HoldingRoutedEventArgsProjection.self))
    }

    // MARK: Windows.UI.Xaml.Input.IHoldingRoutedEventArgs members
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Input.HoldingRoutedEventArgs", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}