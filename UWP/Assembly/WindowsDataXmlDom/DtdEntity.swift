...
public final class WindowsDataXmlDom_DtdEntity: WindowsRuntime.WinRTImport<WindowsDataXmlDom_DtdEntityProjection>, WindowsDataXmlDom_IXmlNodeProtocol, WindowsDataXmlDom_IXmlNodeSerializerProtocol, WindowsDataXmlDom_IXmlNodeSelectorProtocol {
    // MARK: Windows.Data.Xml.Dom.IDtdEntity members

    /// Gets the notation name.
    /// - Returns: The notation name.
    public var notationName: WindowsRuntime.IInspectable {
        get throws {
            try COM.NullResult.unwrap(_interop.get_NotationName())
        }
    }

    /// Gets the public identifier associated with the entity.
    /// - Returns: The public identifier associated with the entity.
    ...
    /// - Returns: The system identifier associated with the entity.
