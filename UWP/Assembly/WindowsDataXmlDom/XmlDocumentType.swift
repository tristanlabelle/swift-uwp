...
public final class WindowsDataXmlDom_XmlDocumentType: WindowsRuntime.WinRTImport<WindowsDataXmlDom_XmlDocumentTypeProjection>, WindowsDataXmlDom_IXmlNodeProtocol, WindowsDataXmlDom_IXmlNodeSerializerProtocol, WindowsDataXmlDom_IXmlNodeSelectorProtocol {
    // MARK: Windows.Data.Xml.Dom.IXmlDocumentType members

    /// Gets a list of the entities declared in the **<!DOCTYPE>** declaration.
    /// - Returns: A list of the general entities, both external and internal, that are present in this document.
    public var entities: WindowsDataXmlDom_XmlNamedNodeMap {
        get throws {
            try COM.NullResult.unwrap(_interop.get_Entities())
        }
    }
    ...
    /// - Returns: A list of DtdNotation members that are present in the document type declaration.
    public var notations: WindowsDataXmlDom_XmlNamedNodeMap {
        get throws {
            try COM.NullResult.unwrap(_interop.get_Notations())
        }
    }
