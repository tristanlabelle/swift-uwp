...
public final class WindowsDataXmlDom_XmlComment: WindowsRuntime.WinRTImport<WindowsDataXmlDom_XmlCommentProjection>, WindowsDataXmlDom_IXmlCharacterDataProtocol, WindowsDataXmlDom_IXmlNodeProtocol, WindowsDataXmlDom_IXmlNodeSerializerProtocol, WindowsDataXmlDom_IXmlNodeSelectorProtocol {
    ...
    /// - Returns: The list of child nodes. This value is always NULL.
    ...
    /// - Returns: The last child node. This property always returns NULL.
    ...
    /// - Returns: Gets or sets the text associated with the node.
