...
public final class WindowsDataXmlDom_XmlProcessingInstruction: WindowsRuntime.WinRTImport<WindowsDataXmlDom_XmlProcessingInstructionProjection>, WindowsDataXmlDom_IXmlNodeProtocol, WindowsDataXmlDom_IXmlNodeSerializerProtocol, WindowsDataXmlDom_IXmlNodeSelectorProtocol {
    // MARK: Windows.Data.Xml.Dom.IXmlProcessingInstruction members
    ...
    /// - Returns: The target application to which this processing instruction is directed.
