...
public final class WindowsDataXmlDom_XmlText: WindowsRuntime.WinRTImport<WindowsDataXmlDom_XmlTextProjection>, WindowsDataXmlDom_IXmlTextProtocol, WindowsDataXmlDom_IXmlCharacterDataProtocol, WindowsDataXmlDom_IXmlNodeProtocol, WindowsDataXmlDom_IXmlNodeSerializerProtocol, WindowsDataXmlDom_IXmlNodeSelectorProtocol {
    ...
    public func splitText(_ offset: Swift.UInt32) throws -> WindowsDataXmlDom_IXmlText {
        try COM.NullResult.unwrap(_interop.splitText(offset))
    }
    ...
    /// - Parameter offset: The offset, in characters, from the beginning of the string. An offset of zero indicates copying from the start of the data.
    /// - Parameter count: The number of characters to retrieve from the specified offset.
