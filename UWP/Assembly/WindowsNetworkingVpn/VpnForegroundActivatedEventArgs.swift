...
public final class WindowsNetworkingVpn_VpnForegroundActivatedEventArgs: WindowsRuntime.WinRTImport<WindowsNetworkingVpn_VpnForegroundActivatedEventArgsProjection>, WindowsApplicationModelActivation_IActivatedEventArgsProtocol, WindowsApplicationModelActivation_IActivatedEventArgsWithUserProtocol {
    // MARK: Windows.Networking.Vpn.IVpnForegroundActivatedEventArgs members

    public var activationOperation: WindowsNetworkingVpn_VpnForegroundActivationOperation {
        get throws {
            try COM.NullResult.unwrap(_interop.get_ActivationOperation())
        }
    }
    ...
    public var sharedContext: WindowsFoundationCollections_ValueSet {
        get throws {
