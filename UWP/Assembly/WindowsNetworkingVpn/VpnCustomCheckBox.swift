...
public final class WindowsNetworkingVpn_VpnCustomCheckBox: WindowsRuntime.WinRTImport<WindowsNetworkingVpn_VpnCustomCheckBoxProjection>, WindowsNetworkingVpn_IVpnCustomPromptProtocol {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsNetworkingVpn_VpnCustomCheckBoxProjection.self))
    }

    // MARK: Windows.Networking.Vpn.IVpnCustomCheckBox members

    /// Not supported.
    /// - Returns: Not supported.
    public var checked: Swift.Bool {
        get throws {
            try _interop.get_Checked()
        }
    }

    /// Not supported.
    /// - Returns: Not supported.
    public var initialCheckState: Swift.Bool {
        get throws {
            try _interop.get_InitialCheckState()
        }
    }

    /// Not supported.
    /// - Returns: Not supported.
    public func initialCheckState(_ value: Swift.Bool) throws {
        try _interop.put_InitialCheckState(value)
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Networking.Vpn.VpnCustomCheckBox", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}