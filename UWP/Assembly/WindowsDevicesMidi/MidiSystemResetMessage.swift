...
public final class WindowsDevicesMidi_MidiSystemResetMessage: WindowsRuntime.WinRTImport<WindowsDevicesMidi_MidiSystemResetMessageProjection>, WindowsDevicesMidi_IMidiMessageProtocol {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsDevicesMidi_MidiSystemResetMessageProjection.self))
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Devices.Midi.MidiSystemResetMessage", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}