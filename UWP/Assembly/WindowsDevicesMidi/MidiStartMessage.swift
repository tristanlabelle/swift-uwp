...
public final class WindowsDevicesMidi_MidiStartMessage: WindowsRuntime.WinRTImport<WindowsDevicesMidi_MidiStartMessageProjection>, WindowsDevicesMidi_IMidiMessageProtocol {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsDevicesMidi_MidiStartMessageProjection.self))
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Devices.Midi.MidiStartMessage", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}