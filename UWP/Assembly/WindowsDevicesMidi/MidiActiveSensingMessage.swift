...
public final class WindowsDevicesMidi_MidiActiveSensingMessage: WindowsRuntime.WinRTImport<WindowsDevicesMidi_MidiActiveSensingMessageProjection>, WindowsDevicesMidi_IMidiMessageProtocol {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsDevicesMidi_MidiActiveSensingMessageProjection.self))
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Devices.Midi.MidiActiveSensingMessage", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}