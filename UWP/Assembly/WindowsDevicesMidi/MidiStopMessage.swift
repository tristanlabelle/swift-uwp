...
public final class WindowsDevicesMidi_MidiStopMessage: WindowsRuntime.WinRTImport<WindowsDevicesMidi_MidiStopMessageProjection>, WindowsDevicesMidi_IMidiMessageProtocol {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsDevicesMidi_MidiStopMessageProjection.self))
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Devices.Midi.MidiStopMessage", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}