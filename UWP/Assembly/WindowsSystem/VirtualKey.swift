...
public struct WindowsSystem_VirtualKey: RawRepresentable, Hashable, Codable {
    ...
    public static let imeOn = Self(rawValue: 22)
    ...
    public static let imeOff = Self(rawValue: 26)
