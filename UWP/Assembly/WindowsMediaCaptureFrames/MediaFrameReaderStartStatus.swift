...
public struct WindowsMediaCaptureFrames_MediaFrameReaderStartStatus: RawRepresentable, Hashable, Codable {
    ...
    public static let outputFormatNotSupported = Self(rawValue: 3)

    /// The operation failed because exclusive control of the media frame source device is unavailable.
    public static let exclusiveControlNotAvailable = Self(rawValue: 4)
}