...
public final class WindowsDevicesPerception_PerceptionDepthFrameSourceWatcher: WindowsRuntime.WinRTImport<WindowsDevicesPerception_PerceptionDepthFrameSourceWatcherProjection> {
    // MARK: Windows.Devices.Perception.IPerceptionDepthFrameSourceWatcher members

    /// Gets the operational status of the depth frame source watcher.
    /// - Returns: A DeviceWatcherStatus enumeration value indicating the status of the depth frame source watcher.
    ...
    public func enumerationCompleted(adding handler: WindowsFoundation_TypedEventHandler<WindowsDevicesPerception_PerceptionDepthFrameSourceWatcher?, WindowsRuntime.IInspectable?>?) throws -> WindowsRuntime.EventRegistration {
    ...
    public func sourceAdded(adding handler: WindowsFoundation_TypedEventHandler<WindowsDevicesPerception_PerceptionDepthFrameSourceWatcher?, WindowsDevicesPerception_PerceptionDepthFrameSourceAddedEventArgs?>?) throws -> WindowsRuntime.EventRegistration {
    ...
    public func sourceRemoved(adding handler: WindowsFoundation_TypedEventHandler<WindowsDevicesPerception_PerceptionDepthFrameSourceWatcher?, WindowsDevicesPerception_PerceptionDepthFrameSourceRemovedEventArgs?>?) throws -> WindowsRuntime.EventRegistration {
    ...
    public func stopped(adding handler: WindowsFoundation_TypedEventHandler<WindowsDevicesPerception_PerceptionDepthFrameSourceWatcher?, WindowsRuntime.IInspectable?>?) throws -> WindowsRuntime.EventRegistration {
