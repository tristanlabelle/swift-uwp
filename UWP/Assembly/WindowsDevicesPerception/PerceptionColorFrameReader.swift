...
public final class WindowsDevicesPerception_PerceptionColorFrameReader: WindowsRuntime.WinRTImport<WindowsDevicesPerception_PerceptionColorFrameReaderProjection>, WindowsFoundation_IClosableProtocol {
    // MARK: Windows.Devices.Perception.IPerceptionColorFrameReader members
    ...
    /// - Returns: The color frame source this reader gets frames from.
    public var source: WindowsDevicesPerception_PerceptionColorFrameSource {
        get throws {
    ...
    public func frameArrived(adding handler: WindowsFoundation_TypedEventHandler<WindowsDevicesPerception_PerceptionColorFrameReader?, WindowsDevicesPerception_PerceptionColorFrameArrivedEventArgs?>?) throws -> WindowsRuntime.EventRegistration {
    ...
    /// - Returns: If the attempt was successful, this method returns the most recent frame that is available to this color frame reader. If the attempt was not successful, this method returns null.
    public func tryReadLatestFrame() throws -> WindowsDevicesPerception_PerceptionColorFrame {
