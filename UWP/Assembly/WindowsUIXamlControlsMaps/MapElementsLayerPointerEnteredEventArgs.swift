...
public final class WindowsUIXamlControlsMaps_MapElementsLayerPointerEnteredEventArgs: WindowsRuntime.WinRTImport<WindowsUIXamlControlsMaps_MapElementsLayerPointerEnteredEventArgsProjection> {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsUIXamlControlsMaps_MapElementsLayerPointerEnteredEventArgsProjection.self))
    }

    // MARK: Windows.UI.Xaml.Controls.Maps.IMapElementsLayerPointerEnteredEventArgs members
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Controls.Maps.MapElementsLayerPointerEnteredEventArgs", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}