...
public final class WindowsUIXamlControlsMaps_MapRightTappedEventArgs: WindowsRuntime.WinRTImport<WindowsUIXamlControlsMaps_MapRightTappedEventArgsProjection> {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsUIXamlControlsMaps_MapRightTappedEventArgsProjection.self))
    }

    // MARK: Windows.UI.Xaml.Controls.Maps.IMapRightTappedEventArgs members
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Controls.Maps.MapRightTappedEventArgs", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}