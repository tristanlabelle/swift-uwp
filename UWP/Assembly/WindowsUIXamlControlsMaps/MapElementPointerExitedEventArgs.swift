...
public final class WindowsUIXamlControlsMaps_MapElementPointerExitedEventArgs: WindowsRuntime.WinRTImport<WindowsUIXamlControlsMaps_MapElementPointerExitedEventArgsProjection> {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsUIXamlControlsMaps_MapElementPointerExitedEventArgsProjection.self))
    }

    // MARK: Windows.UI.Xaml.Controls.Maps.IMapElementPointerExitedEventArgs members
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Controls.Maps.MapElementPointerExitedEventArgs", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}