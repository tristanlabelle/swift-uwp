...
public final class WindowsMediaPlayback_MediaPlaybackAudioTrackList: WindowsRuntime.WinRTImport<WindowsMediaPlayback_MediaPlaybackAudioTrackListProjection>, WindowsFoundationCollections_IVectorViewProtocol, WindowsFoundationCollections_IIterableProtocol, WindowsMediaCore_ISingleSelectMediaTrackListProtocol {
    public typealias T = WindowsMediaCore_AudioTrack?

    // MARK: Windows.Foundation.Collections.IVectorView`1<Windows.Media.Core.AudioTrack> members

    /// Gets the number of audio tracks in the list.
    /// - Returns: The number of audio tracks in the list.
    ...
    /// - Parameter index: The zero-based index of the audio track.
    /// - Returns: The audio track at the specified index.
    public func getAt(_ index: Swift.UInt32) throws -> WindowsMediaCore_AudioTrack? {
        try _interop.getAt(index)
    }

    /// Retrieves the index of a specified audio track in the list.
    /// - Parameter value: The audio track to find in the vector view.
    /// - Parameter index: If the audio track is found, this is the zero-based index of the audio track; otherwise, this parameter is 0.
    /// - Returns: True if the audio track is found; otherwise, false.
    public func indexOf(_ value: WindowsMediaCore_AudioTrack?, _ index: inout Swift.UInt32) throws -> Swift.Bool {
        try _interop.indexOf(value, &index)
    }

    /// Retrieves the audio tracks that start at the specified index in the list.
    /// - Parameter startIndex: The zero-based index of the start of the audio tracks in the list.
    /// - Parameter items: The audio tracks that start at *startIndex* in the list.
    /// - Returns: The number of audio tracks retrieved.
    public func getMany(_ startIndex: Swift.UInt32, _ items: [WindowsMediaCore_AudioTrack?]) throws -> Swift.UInt32 {
        try _interop.getMany(startIndex, items)
    }

    // MARK: Windows.Foundation.Collections.IIterable`1<Windows.Media.Core.AudioTrack> members

    /// Returns an iterator that iterates over the items in the collection.
    /// - Returns: The iterator.
    public func first() throws -> WindowsFoundationCollections_IIterator<WindowsMediaCore_AudioTrack?> {
    ...
    /// - Returns: The index of the currently selected audio track in the list.
    ...
    private var _iiterable_storage: COM.COMInterop<CWinRT.SWRT_WindowsFoundationCollections_IIterable_WindowsMediaCore_AudioTrack>? = nil

    internal var _iiterable: COM.COMInterop<CWinRT.SWRT_WindowsFoundationCollections_IIterable_WindowsMediaCore_AudioTrack> {
        get throws {
            try _iiterable_storage.lazyInit {
                try _queryInterfacePointer(CWinRT.SWRT_WindowsFoundationCollections_IIterable_WindowsMediaCore_AudioTrack.iid).cast(to: CWinRT.SWRT_WindowsFoundationCollections_IIterable_WindowsMediaCore_AudioTrack.self)
            }
        }
    }
