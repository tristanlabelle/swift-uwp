...
public final class WindowsMediaPlayback_MediaPlaybackCommandManagerPreviousReceivedEventArgs: WindowsRuntime.WinRTImport<WindowsMediaPlayback_MediaPlaybackCommandManagerPreviousReceivedEventArgsProjection> {
    // MARK: Windows.Media.Playback.IMediaPlaybackCommandManagerPreviousReceivedEventArgs members
