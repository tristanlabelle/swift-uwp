...
public final class WindowsMediaPlayback_MediaPlaybackCommandManagerFastForwardReceivedEventArgs: WindowsRuntime.WinRTImport<WindowsMediaPlayback_MediaPlaybackCommandManagerFastForwardReceivedEventArgsProjection> {
    // MARK: Windows.Media.Playback.IMediaPlaybackCommandManagerFastForwardReceivedEventArgs members
    ...
    /// Gets a Deferral object that causes the system to wait for you to perform asynchronous operations, such as creating a new MediaPlaybackItem from a network source, before it continues processing the **Fast-forward** command.
