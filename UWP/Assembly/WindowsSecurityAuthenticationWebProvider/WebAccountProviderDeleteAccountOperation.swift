...
public final class WindowsSecurityAuthenticationWebProvider_WebAccountProviderDeleteAccountOperation: WindowsRuntime.WinRTImport<WindowsSecurityAuthenticationWebProvider_WebAccountProviderDeleteAccountOperationProjection>, WindowsSecurityAuthenticationWebProvider_IWebAccountProviderOperationProtocol, WindowsSecurityAuthenticationWebProvider_IWebAccountProviderBaseReportOperationProtocol {
    // MARK: Windows.Security.Authentication.Web.Provider.IWebAccountProviderDeleteAccountOperation members

    /// Gets the web account to delete.
    /// - Returns: The web account to delete.
