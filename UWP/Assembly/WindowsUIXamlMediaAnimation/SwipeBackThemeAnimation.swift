...
public final class WindowsUIXamlMediaAnimation_SwipeBackThemeAnimation: WindowsRuntime.WinRTImport<WindowsUIXamlMediaAnimation_SwipeBackThemeAnimationProjection> {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsUIXamlMediaAnimation_SwipeBackThemeAnimationProjection.self))
    }

    // MARK: Windows.UI.Xaml.Media.Animation.ISwipeBackThemeAnimation members
    ...
    // MARK: Windows.UI.Xaml.Media.Animation.ISwipeBackThemeAnimationStatics members
    ...
    public static var fromHorizontalOffsetProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_iswipeBackThemeAnimationStatics.get_FromHorizontalOffsetProperty())
        }
    }
    ...
    public static var fromVerticalOffsetProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_iswipeBackThemeAnimationStatics.get_FromVerticalOffsetProperty())
        }
    }
    ...
    public static var targetNameProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_iswipeBackThemeAnimationStatics.get_TargetNameProperty())
        }
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Media.Animation.SwipeBackThemeAnimation", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }

    private static var _iswipeBackThemeAnimationStatics_storage: COM.COMInterop<CWinRT.SWRT_WindowsUIXamlMediaAnimation_ISwipeBackThemeAnimationStatics>? = nil

    internal static var _iswipeBackThemeAnimationStatics: COM.COMInterop<CWinRT.SWRT_WindowsUIXamlMediaAnimation_ISwipeBackThemeAnimationStatics> {
        get throws {
            try _iswipeBackThemeAnimationStatics_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Media.Animation.SwipeBackThemeAnimation", id: CWinRT.SWRT_WindowsUIXamlMediaAnimation_ISwipeBackThemeAnimationStatics.iid)
            }
        }
    }
}