...
public final class WindowsUIXamlMediaAnimation_SplitOpenThemeAnimation: WindowsRuntime.WinRTImport<WindowsUIXamlMediaAnimation_SplitOpenThemeAnimationProjection> {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsUIXamlMediaAnimation_SplitOpenThemeAnimationProjection.self))
    }

    // MARK: Windows.UI.Xaml.Media.Animation.ISplitOpenThemeAnimation members
    ...
    // MARK: Windows.UI.Xaml.Media.Animation.ISplitOpenThemeAnimationStatics members
    ...
    public static var closedLengthProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_ClosedLengthProperty())
        }
    }
    ...
    public static var closedTargetNameProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_ClosedTargetNameProperty())
        }
    }
    ...
    public static var closedTargetProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_ClosedTargetProperty())
        }
    }
    ...
    public static var contentTargetNameProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_ContentTargetNameProperty())
        }
    }
    ...
    public static var contentTargetProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_ContentTargetProperty())
        }
    }
    ...
    public static var contentTranslationDirectionProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_ContentTranslationDirectionProperty())
        }
    }
    ...
    public static var contentTranslationOffsetProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_ContentTranslationOffsetProperty())
        }
    }
    ...
    public static var offsetFromCenterProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_OffsetFromCenterProperty())
        }
    }
    ...
    public static var openedLengthProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_OpenedLengthProperty())
        }
    }
    ...
    public static var openedTargetNameProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_OpenedTargetNameProperty())
        }
    }
    ...
    public static var openedTargetProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_isplitOpenThemeAnimationStatics.get_OpenedTargetProperty())
        }
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Media.Animation.SplitOpenThemeAnimation", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }

    private static var _isplitOpenThemeAnimationStatics_storage: COM.COMInterop<CWinRT.SWRT_WindowsUIXamlMediaAnimation_ISplitOpenThemeAnimationStatics>? = nil

    internal static var _isplitOpenThemeAnimationStatics: COM.COMInterop<CWinRT.SWRT_WindowsUIXamlMediaAnimation_ISplitOpenThemeAnimationStatics> {
        get throws {
            try _isplitOpenThemeAnimationStatics_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Media.Animation.SplitOpenThemeAnimation", id: CWinRT.SWRT_WindowsUIXamlMediaAnimation_ISplitOpenThemeAnimationStatics.iid)
            }
        }
    }
}