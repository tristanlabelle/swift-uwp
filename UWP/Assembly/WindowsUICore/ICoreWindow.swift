...
public protocol WindowsUICore_ICoreWindowProtocol: IInspectableProtocol {
    ...
    /// - Returns: The bounding rectangle of the window, in device-independent pixel (DIP).
    ...
    /// - Returns: True if input is enabled for the window; false if it is disabled.
    ...
    /// - Returns: The current position of the cursor in device-independent pixels (DIPs).
