...
public final class WindowsUIInput_RadialControllerButtonReleasedEventArgs: WindowsRuntime.WinRTImport<WindowsUIInput_RadialControllerButtonReleasedEventArgsProjection> {
    // MARK: Windows.UI.Input.IRadialControllerButtonReleasedEventArgs members
