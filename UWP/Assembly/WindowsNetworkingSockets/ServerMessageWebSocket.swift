...
public final class WindowsNetworkingSockets_ServerMessageWebSocket: WindowsRuntime.WinRTImport<WindowsNetworkingSockets_ServerMessageWebSocketProjection>, WindowsFoundation_IClosableProtocol {
    // MARK: Windows.Networking.Sockets.IServerMessageWebSocket members

    /// Gets socket control data on a ServerMessageWebSocket object.
    /// - Returns: Socket control data on a ServerMessageWebSocket object.
    public var control: WindowsNetworkingSockets_ServerMessageWebSocketControl {
        get throws {
    ...
    /// - Returns: Socket information on a ServerMessageWebSocket object.
    public var information: WindowsNetworkingSockets_ServerMessageWebSocketInformation {
        get throws {
    ...
    public func closed(adding value: WindowsFoundation_TypedEventHandler<WindowsNetworkingSockets_ServerMessageWebSocket?, WindowsNetworkingSockets_WebSocketClosedEventArgs?>?) throws -> WindowsRuntime.EventRegistration {
    ...
    public func messageReceived(adding value: WindowsFoundation_TypedEventHandler<WindowsNetworkingSockets_ServerMessageWebSocket?, WindowsNetworkingSockets_MessageWebSocketMessageReceivedEventArgs?>?) throws -> WindowsRuntime.EventRegistration {
        let _token = try _interop.add_MessageReceived(value)
