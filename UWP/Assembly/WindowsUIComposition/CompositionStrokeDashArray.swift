...
public final class WindowsUIComposition_CompositionStrokeDashArray: WindowsRuntime.WinRTImport<WindowsUIComposition_CompositionStrokeDashArrayProjection>, WindowsFoundationCollections_IVectorProtocol, WindowsFoundationCollections_IIterableProtocol {
    public typealias T = Swift.Float

    // MARK: Windows.Foundation.Collections.IVector`1<Single> members
    ...
    // MARK: Windows.Foundation.Collections.IIterable`1<Single> members
    ...
    private var _iiterable_storage: COM.COMInterop<CWinRT.SWRT_WindowsFoundationCollections_IIterable_Float>? = nil

    internal var _iiterable: COM.COMInterop<CWinRT.SWRT_WindowsFoundationCollections_IIterable_Float> {
        get throws {
            try _iiterable_storage.lazyInit {
                try _queryInterfacePointer(CWinRT.SWRT_WindowsFoundationCollections_IIterable_Float.iid).cast(to: CWinRT.SWRT_WindowsFoundationCollections_IIterable_Float.self)
            }
        }
    }
