...
/// Specifies the deployment options that you can configure when you use the AddPackageByUriAsync method to add a package.
public final class WindowsManagementDeployment_AddPackageOptions: WindowsRuntime.WinRTImport<WindowsManagementDeployment_AddPackageOptionsProjection> {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsManagementDeployment_AddPackageOptionsProjection.self))
    }

    // MARK: Windows.Management.Deployment.IAddPackageOptions members
    ...
    /// - Returns: **TRUE** forces a specific version of a package to be added, regardless of if a higher version is already added; otherwise, **FALSE**.
    ...
    /// - Returns: The list of package family names from the main bundle to be added.
    ...
    /// - Returns: **TRUE** indicates that, in the case of a failed deployment, files that have been created on the target machine during the install process will be removed; otherwise, **FALSE**.
    public var retainFilesOnFailure: Swift.Bool {
        get throws {
            try _interop.get_RetainFilesOnFailure()
        }
    }

    /// Gets or sets a value that indicates whether to remove files that have been created on the target machine during the install process in the case of a failed deployment.
    /// - Returns: **TRUE** indicates that, in the case of a failed deployment, files that have been created on the target machine during the install process will be removed; otherwise, **FALSE**.
    public func retainFilesOnFailure(_ value: Swift.Bool) throws {
        try _interop.put_RetainFilesOnFailure(value)
    }
    ...
    /// - Returns: The volume to which the package is added.
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Management.Deployment.AddPackageOptions", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}