...
public final class WindowsApplicationModelBackground_CachedFileUpdaterTrigger: WindowsRuntime.WinRTImport<WindowsApplicationModelBackground_CachedFileUpdaterTriggerProjection>, WindowsApplicationModelBackground_IBackgroundTriggerProtocol {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsApplicationModelBackground_CachedFileUpdaterTriggerProjection.self))
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.ApplicationModel.Background.CachedFileUpdaterTrigger", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}