...
public final class WindowsApplicationModelBackground_RcsEndUserMessageAvailableTrigger: WindowsRuntime.WinRTImport<WindowsApplicationModelBackground_RcsEndUserMessageAvailableTriggerProjection>, WindowsApplicationModelBackground_IBackgroundTriggerProtocol {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsApplicationModelBackground_RcsEndUserMessageAvailableTriggerProjection.self))
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.ApplicationModel.Background.RcsEndUserMessageAvailableTrigger", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}