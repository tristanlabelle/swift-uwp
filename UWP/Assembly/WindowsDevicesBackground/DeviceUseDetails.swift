...
public final class WindowsDevicesBackground_DeviceUseDetails: WindowsRuntime.WinRTImport<WindowsDevicesBackground_DeviceUseDetailsProjection> {
    // MARK: Windows.Devices.Background.IDeviceUseDetails members
