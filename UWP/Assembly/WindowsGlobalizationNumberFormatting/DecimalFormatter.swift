...
public final class WindowsGlobalizationNumberFormatting_DecimalFormatter: WindowsRuntime.WinRTImport<WindowsGlobalizationNumberFormatting_DecimalFormatterProjection>, WindowsGlobalizationNumberFormatting_INumberFormatterOptionsProtocol, WindowsGlobalizationNumberFormatting_INumberFormatterProtocol, WindowsGlobalizationNumberFormatting_INumberFormatter2Protocol, WindowsGlobalizationNumberFormatting_INumberParserProtocol, WindowsGlobalizationNumberFormatting_ISignificantDigitsOptionProtocol, WindowsGlobalizationNumberFormatting_INumberRounderOptionProtocol, WindowsGlobalizationNumberFormatting_ISignedZeroOptionProtocol {
    ...
    public convenience init(_ languages: WindowsFoundationCollections_IIterable<Swift.String>?, _ geographicRegion: Swift.String) throws {
        self.init(_transferringRef: try COM.NullResult.unwrap(Self._idecimalFormatterFactory.createDecimalFormatter(languages, geographicRegion)))
    }
    ...
    /// - Returns: The geographic region that was most recently used to format or parse decimal values.
    ...
    /// - Returns: The language from the priority list of language identifiers that was most recently used to format or parse decimal values.
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Globalization.NumberFormatting.DecimalFormatter", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }

    private static var _idecimalFormatterFactory_storage: COM.COMInterop<CWinRT.SWRT_WindowsGlobalizationNumberFormatting_IDecimalFormatterFactory>? = nil

    internal static var _idecimalFormatterFactory: COM.COMInterop<CWinRT.SWRT_WindowsGlobalizationNumberFormatting_IDecimalFormatterFactory> {
        get throws {
            try _idecimalFormatterFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Globalization.NumberFormatting.DecimalFormatter", id: CWinRT.SWRT_WindowsGlobalizationNumberFormatting_IDecimalFormatterFactory.iid)
            }
        }
    }
}