...
public final class WindowsApplicationModelActivation_AppointmentsProviderRemoveAppointmentActivatedEventArgs: WindowsRuntime.WinRTImport<WindowsApplicationModelActivation_AppointmentsProviderRemoveAppointmentActivatedEventArgsProjection>, WindowsApplicationModelActivation_IAppointmentsProviderRemoveAppointmentActivatedEventArgsProtocol, WindowsApplicationModelActivation_IAppointmentsProviderActivatedEventArgsProtocol, WindowsApplicationModelActivation_IActivatedEventArgsProtocol, WindowsApplicationModelActivation_IActivatedEventArgsWithUserProtocol {
    // MARK: Windows.ApplicationModel.Activation.IAppointmentsProviderRemoveAppointmentActivatedEventArgs members

    /// Gets the appointment that is provided to the app when the user tries to remove it.
    /// - Returns: The appointment that is removed.
    public var removeAppointmentOperation: WindowsApplicationModelAppointmentsAppointmentsProvider_RemoveAppointmentOperation {
        get throws {
            try COM.NullResult.unwrap(_interop.get_RemoveAppointmentOperation())
        }
    }
