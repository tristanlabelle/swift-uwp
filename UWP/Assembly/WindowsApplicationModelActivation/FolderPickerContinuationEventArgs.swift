...
public final class WindowsApplicationModelActivation_FolderPickerContinuationEventArgs: WindowsRuntime.WinRTImport<WindowsApplicationModelActivation_FolderPickerContinuationEventArgsProjection>, WindowsApplicationModelActivation_IFolderPickerContinuationEventArgsProtocol, WindowsApplicationModelActivation_IContinuationActivatedEventArgsProtocol, WindowsApplicationModelActivation_IActivatedEventArgsProtocol, WindowsApplicationModelActivation_IActivatedEventArgsWithUserProtocol {
    ...
    /// - Returns: The ActivationKind.ContinueFolderPicker enumeration value.
