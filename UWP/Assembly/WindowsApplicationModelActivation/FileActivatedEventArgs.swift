...
public final class WindowsApplicationModelActivation_FileActivatedEventArgs: WindowsRuntime.WinRTImport<WindowsApplicationModelActivation_FileActivatedEventArgsProjection>, WindowsApplicationModelActivation_IFileActivatedEventArgsProtocol, WindowsApplicationModelActivation_IActivatedEventArgsProtocol, WindowsApplicationModelActivation_IFileActivatedEventArgsWithNeighboringFilesProtocol, WindowsApplicationModelActivation_IFileActivatedEventArgsWithCallerPackageFamilyNameProtocol, WindowsApplicationModelActivation_IApplicationViewActivatedEventArgsProtocol, WindowsApplicationModelActivation_IViewSwitcherProviderProtocol, WindowsApplicationModelActivation_IActivatedEventArgsWithUserProtocol {
    ...
    // MARK: Windows.ApplicationModel.Activation.IFileActivatedEventArgsWithCallerPackageFamilyName members
    ...
    public var callerPackageFamilyName: Swift.String {
        get throws {
            try _ifileActivatedEventArgsWithCallerPackageFamilyName.get_CallerPackageFamilyName()
        }
    }
    ...
    private var _ifileActivatedEventArgsWithCallerPackageFamilyName_storage: COM.COMInterop<CWinRT.SWRT_WindowsApplicationModelActivation_IFileActivatedEventArgsWithCallerPackageFamilyName>? = nil

    internal var _ifileActivatedEventArgsWithCallerPackageFamilyName: COM.COMInterop<CWinRT.SWRT_WindowsApplicationModelActivation_IFileActivatedEventArgsWithCallerPackageFamilyName> {
        get throws {
            try _ifileActivatedEventArgsWithCallerPackageFamilyName_storage.lazyInit {
                try _queryInterfacePointer(CWinRT.SWRT_WindowsApplicationModelActivation_IFileActivatedEventArgsWithCallerPackageFamilyName.iid).cast(to: CWinRT.SWRT_WindowsApplicationModelActivation_IFileActivatedEventArgsWithCallerPackageFamilyName.self)
            }
        }
    }
    ...
    deinit {
        ...
        _ifileActivatedEventArgsWithCallerPackageFamilyName_storage?.release()
