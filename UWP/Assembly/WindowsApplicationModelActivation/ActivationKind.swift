...
public struct WindowsApplicationModelActivation_ActivationKind: RawRepresentable, Hashable, Codable {
    ...
    public static let printSupportJobUI = Self(rawValue: 1023)
    public static let printSupportSettingsUI = Self(rawValue: 1024)
    public static let phoneCallActivation = Self(rawValue: 1025)
    public static let vpnForeground = Self(rawValue: 1026)
}