...
public final class WindowsApplicationModelActivation_AppointmentsProviderAddAppointmentActivatedEventArgs: WindowsRuntime.WinRTImport<WindowsApplicationModelActivation_AppointmentsProviderAddAppointmentActivatedEventArgsProjection>, WindowsApplicationModelActivation_IAppointmentsProviderAddAppointmentActivatedEventArgsProtocol, WindowsApplicationModelActivation_IAppointmentsProviderActivatedEventArgsProtocol, WindowsApplicationModelActivation_IActivatedEventArgsProtocol, WindowsApplicationModelActivation_IActivatedEventArgsWithUserProtocol {
    // MARK: Windows.ApplicationModel.Activation.IAppointmentsProviderAddAppointmentActivatedEventArgs members

    /// Gets the appointment that is provided to the app when the user tries to add it.
    /// - Returns: The appointment that is added.
    public var addAppointmentOperation: WindowsApplicationModelAppointmentsAppointmentsProvider_AddAppointmentOperation {
        get throws {
            try COM.NullResult.unwrap(_interop.get_AddAppointmentOperation())
        }
    }
