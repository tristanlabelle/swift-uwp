...
public final class WindowsGraphicsPrintingWorkflow_PrintWorkflowJobActivatedEventArgs: WindowsRuntime.WinRTImport<WindowsGraphicsPrintingWorkflow_PrintWorkflowJobActivatedEventArgsProjection>, WindowsApplicationModelActivation_IActivatedEventArgsProtocol, WindowsApplicationModelActivation_IActivatedEventArgsWithUserProtocol {
    // MARK: Windows.Graphics.Printing.Workflow.IPrintWorkflowJobActivatedEventArgs members

    public var session: WindowsGraphicsPrintingWorkflow_PrintWorkflowJobUISession {
        get throws {
