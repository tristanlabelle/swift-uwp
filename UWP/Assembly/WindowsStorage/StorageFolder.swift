...
public final class WindowsStorage_StorageFolder: WindowsRuntime.WinRTImport<WindowsStorage_StorageFolderProjection>, WindowsStorage_IStorageFolderProtocol, WindowsStorage_IStorageItemProtocol, WindowsStorageSearch_IStorageFolderQueryOperationsProtocol, WindowsStorage_IStorageItemPropertiesProtocol, WindowsStorage_IStorageItemProperties2Protocol, WindowsStorage_IStorageItem2Protocol, WindowsStorage_IStorageFolder2Protocol, WindowsStorage_IStorageItemPropertiesWithProviderProtocol {
    ...
    /// - Returns: The attributes of the current folder.
    ...
    /// - Returns: The date and time that the current folder was created as type DateTime.
    ...
    /// - Returns: The full path of the current folder in the file system, if the path is available.
    ...
    /// - Returns: The user-friendly name of the current folder.
    ...
    /// - Returns: The user-friendly description of the type of the folder; for example, `JPEG image`.
    ...
    /// - Returns: The identifier for the current folder or file group within a query result or StorageFolder.
    ...
    /// - Returns: The object that provides access to the content-related properties of the folder.
    ...
    /// - Returns: The StorageProvider object that contains info about the service that stores the current folder. The folder may be stored by the local file system or by a remote service like Microsoft OneDrive.
    ...
    // MARK: Windows.Storage.IStorageFolder3 members
    ...
    // MARK: Windows.Storage.IStorageFolderStatics members
    ...
    // MARK: Windows.Storage.IStorageFolderStatics2 members
    ...
    private var _istorageFolder3_storage: COM.COMInterop<CWinRT.SWRT_WindowsStorage_IStorageFolder3>? = nil

    internal var _istorageFolder3: COM.COMInterop<CWinRT.SWRT_WindowsStorage_IStorageFolder3> {
        get throws {
            try _istorageFolder3_storage.lazyInit {
                try _queryInterfacePointer(CWinRT.SWRT_WindowsStorage_IStorageFolder3.iid).cast(to: CWinRT.SWRT_WindowsStorage_IStorageFolder3.self)
            }
        }
    }
    ...
    deinit {
        ...
        _istorageFolder3_storage?.release()
    }

    private static var _istorageFolderStatics_storage: COM.COMInterop<CWinRT.SWRT_WindowsStorage_IStorageFolderStatics>? = nil

    internal static var _istorageFolderStatics: COM.COMInterop<CWinRT.SWRT_WindowsStorage_IStorageFolderStatics> {
        get throws {
            try _istorageFolderStatics_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Storage.StorageFolder", id: CWinRT.SWRT_WindowsStorage_IStorageFolderStatics.iid)
            }
        }
    }

    private static var _istorageFolderStatics2_storage: COM.COMInterop<CWinRT.SWRT_WindowsStorage_IStorageFolderStatics2>? = nil

    internal static var _istorageFolderStatics2: COM.COMInterop<CWinRT.SWRT_WindowsStorage_IStorageFolderStatics2> {
        get throws {
            try _istorageFolderStatics2_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Storage.StorageFolder", id: CWinRT.SWRT_WindowsStorage_IStorageFolderStatics2.iid)
            }
        }
    }
}