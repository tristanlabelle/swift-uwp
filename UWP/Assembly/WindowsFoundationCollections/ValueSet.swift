...
public final class WindowsFoundationCollections_ValueSet: WindowsRuntime.WinRTImport<WindowsFoundationCollections_ValueSetProjection>, WindowsFoundationCollections_IPropertySetProtocol, WindowsFoundationCollections_IObservableMapProtocol, WindowsFoundationCollections_IMapProtocol, WindowsFoundationCollections_IIterableProtocol {
    ...
    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsFoundationCollections_ValueSetProjection.self))
    }
    ...
    /// - Returns: The number of items in the value set.
    ...
    /// - Parameter key: The key.
    /// - Returns: True if the value set has an item with the specified key; otherwise, false.
    ...
    /// - Returns: The iterator. The current position of the iterator is index 0, or the end of the value set if the value set is empty.
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.Foundation.Collections.ValueSet", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }
}