...
public final class WindowsDevicesPointOfService_SlipPrinterCapabilities: WindowsRuntime.WinRTImport<WindowsDevicesPointOfService_SlipPrinterCapabilitiesProjection>, WindowsDevicesPointOfService_ICommonReceiptSlipCapabilitiesProtocol, WindowsDevicesPointOfService_ICommonPosPrintStationCapabilitiesProtocol {
    // MARK: Windows.Devices.PointOfService.ISlipPrinterCapabilities members

    /// Gets whether the slip printer station supports printing on both sides of the document.
    /// - Returns: True if the slip printer station supports printing on both sides of the document; otherwise, false.
    public var isBothSidesPrintingSupported: Swift.Bool {
        get throws {
            try _interop.get_IsBothSidesPrintingSupported()
        }
    }

    /// Gets whether the slip printer station can print full-length forms.
    /// - Returns: True if the slip printer station can print full-length forms. False if the slip printer station is a validation-type station. Validation-type stations usually limit the number of print lines and turn off access to the receipt and journal stations while the validation slip is used.
    public var isFullLengthSupported: Swift.Bool {
        get throws {
            try _interop.get_IsFullLengthSupported()
        }
    }

    // MARK: Windows.Devices.PointOfService.ISlipPrinterCapabilities2 members

    /// Gets whether the slip printer station can reverse paper feed by line.
    /// - Returns: True if the slip printer station can reverse paper feed by line; otherwise false.
    public var isReversePaperFeedByLineSupported: Swift.Bool {
        get throws {
            try _islipPrinterCapabilities2.get_IsReversePaperFeedByLineSupported()
        }
    }

    /// Gets whether the slip printer station can reverse paper feed by map mode unit.
    /// - Returns: True if the slip printer station can reverse paper feed by map mode unit; otherwise false.
    public var isReversePaperFeedByMapModeUnitSupported: Swift.Bool {
        get throws {
            try _islipPrinterCapabilities2.get_IsReversePaperFeedByMapModeUnitSupported()
        }
    }

    /// Gets whether the slip printer station can print characters in reverse-video style.
    /// - Returns: True if the slip printer station can print characters in reverse-video style; otherwise false.
    public var isReverseVideoSupported: Swift.Bool {
        get throws {
            try _islipPrinterCapabilities2.get_IsReverseVideoSupported()
        }
    }

    /// Gets whether the slip printer station can print characters in strikethrough style.
    /// - Returns: True if the slip printer station can print characters in strikethrough style; otherwise false.
    public var isStrikethroughSupported: Swift.Bool {
        get throws {
            try _islipPrinterCapabilities2.get_IsStrikethroughSupported()
        }
    }

    /// Gets whether the slip printer station can print characters in subscript style.
    /// - Returns: True if the slip printer station can print characters in subscript style; otherwise false.
    public var isSubscriptSupported: Swift.Bool {
        get throws {
            try _islipPrinterCapabilities2.get_IsSubscriptSupported()
        }
    }

    /// Gets whether the slip printer station can print characters in superscript style.
    /// - Returns: True if the slip printer station can print characters in superscript style; otherwise false.
    public var isSuperscriptSupported: Swift.Bool {
        get throws {
            try _islipPrinterCapabilities2.get_IsSuperscriptSupported()
        }
    }
    ...
    /// - Returns: True if the slip printer station can print in a rotated upside-down mode; otherwise false.
    ...
    /// - Returns: True if the slip printer station can print barcodes; otherwise false.
    ...
    /// - Returns: True if the slip printer station can print bitmaps; otherwise false.
    ...
    /// - Returns: True if the slip printer station can print information rotated 90 degrees to the left; otherwise false.
    ...
    /// - Returns: True if the slip printer station supports setting a custom size for the area of the page on which the printer station should print; otherwise false.
    ...
    /// - Returns: True if the slip printer station can print information rotated 90 degrees to the right; otherwise false.
    ...
    /// - Returns: Information about the capabilities of the slip printer station to draw ruled lines.
    ...
    /// - Returns: A list of the directions in which the slip printer station can rotate a barcode when printing.
    ...
    /// - Returns: A list of the directions in which the slip printer station can rotate a bitmap when printing.
    ...
    /// - Returns: A combination of enumeration values that indicate the sensors that the slip printer station has available to report the status of the printer station.
    ...
    /// - Returns: A combination of enumeration values that indicates which color cartridges the slip printer station can use to print in color.
    ...
    /// - Returns: True if the slip printer station can print bold characters; otherwise false.
    ...
    /// - Returns: True if the slip printer station can print characters that are both double-high and double-wide; otherwise false.
    ...
    /// - Returns: True if the slip printer station can print double-high characters; otherwise false.
    ...
    /// - Returns: True if the slip printer station can print double-wide characters; otherwise false.
    ...
    /// - Returns: True if the slip printer station can print a dark color plus an alternate color; otherwise false.
    ...
    /// - Returns: True if the slip printer station can print italic characters; otherwise false.
    ...
    /// - Returns: True if the slip printer station has an out-of-paper sensor; otherwise false.
    ...
    /// - Returns: True if the slip printer station has a low-paper sensor; otherwise false.
    ...
    /// - Returns: True if a point-of-service printer with a station that prints forms such as checks or credit card slips is present; otherwise false.
    ...
    /// - Returns: True if the slip printer station can underline characters; otherwise false.
    ...
    /// - Returns: A collection of the line widths in characters per line that the slip printer station supports.
    ...
    private var _islipPrinterCapabilities2_storage: COM.COMInterop<CWinRT.SWRT_WindowsDevicesPointOfService_ISlipPrinterCapabilities2>? = nil

    internal var _islipPrinterCapabilities2: COM.COMInterop<CWinRT.SWRT_WindowsDevicesPointOfService_ISlipPrinterCapabilities2> {
        get throws {
            try _islipPrinterCapabilities2_storage.lazyInit {
                try _queryInterfacePointer(CWinRT.SWRT_WindowsDevicesPointOfService_ISlipPrinterCapabilities2.iid).cast(to: CWinRT.SWRT_WindowsDevicesPointOfService_ISlipPrinterCapabilities2.self)
            }
        }
    }
    ...
    deinit {
        _islipPrinterCapabilities2_storage?.release()
