...
public final class WindowsUIXamlControls_TreeViewDragItemsCompletedEventArgs: WindowsRuntime.WinRTImport<WindowsUIXamlControls_TreeViewDragItemsCompletedEventArgsProjection> {
    // MARK: Windows.UI.Xaml.Controls.ITreeViewDragItemsCompletedEventArgs members
