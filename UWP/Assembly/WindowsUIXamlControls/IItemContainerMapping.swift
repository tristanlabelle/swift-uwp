...
public protocol WindowsUIXamlControls_IItemContainerMappingProtocol: IInspectableProtocol {
    ...
    func itemFromContainer(_ container: WindowsUIXaml_DependencyObject?) throws -> WindowsRuntime.IInspectable
    ...
    func containerFromItem(_ item: WindowsRuntime.IInspectable?) throws -> WindowsUIXaml_DependencyObject
    ...
    func indexFromContainer(_ container: WindowsUIXaml_DependencyObject?) throws -> Swift.Int32
    ...
    func containerFromIndex(_ index: Swift.Int32) throws -> WindowsUIXaml_DependencyObject
}

/// Provides methods that let an ItemsControl map data items to UI containers.
public typealias WindowsUIXamlControls_IItemContainerMapping = any WindowsUIXamlControls_IItemContainerMappingProtocol