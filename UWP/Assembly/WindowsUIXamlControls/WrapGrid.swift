...
public final class WindowsUIXamlControls_WrapGrid: WindowsRuntime.WinRTImport<WindowsUIXamlControls_WrapGridProjection> {
    // MARK: IActivationFactory members

    public convenience init() throws {
        self.init(_transferringRef: try Self._iactivationFactory.activateInstance(projection: WindowsUIXamlControls_WrapGridProjection.self))
    }

    // MARK: Windows.UI.Xaml.Controls.IWrapGrid members
    ...
    /// - Returns: The height of the layout area for each item that is contained in a WrapGrid. The default is Double.NaN, which results in the "Auto" layout behavior.
    ...
    /// - Returns: The width of the layout area for each item that is contained in a WrapGrid. The default is Double.NaN, which results in the "Auto" layout behavior.
    ...
    /// - Returns: The maximum rows or columns that this WrapGrid should present before it introduces wrapping to the layout. The default is -1, which is a special value that indicates no maximum.
    ...
    // MARK: Windows.UI.Xaml.Controls.IWrapGridStatics members
    ...
    public static var horizontalChildrenAlignmentProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_iwrapGridStatics.get_HorizontalChildrenAlignmentProperty())
        }
    }
    ...
    public static var itemHeightProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_iwrapGridStatics.get_ItemHeightProperty())
        }
    }
    ...
    public static var itemWidthProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_iwrapGridStatics.get_ItemWidthProperty())
        }
    }
    ...
    public static var maximumRowsOrColumnsProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_iwrapGridStatics.get_MaximumRowsOrColumnsProperty())
        }
    }
    ...
    public static var orientationProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_iwrapGridStatics.get_OrientationProperty())
        }
    }
    ...
    public static var verticalChildrenAlignmentProperty: WindowsUIXaml_DependencyProperty {
        get throws {
            try COM.NullResult.unwrap(_iwrapGridStatics.get_VerticalChildrenAlignmentProperty())
        }
    }
    ...
    internal static var _iactivationFactory: COM.COMInterop<CWinRT.SWRT_IActivationFactory> {
        get throws {
            try _iactivationFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Controls.WrapGrid", id: CWinRT.SWRT_IActivationFactory.iid)
            }
        }
    }

    private static var _iwrapGridStatics_storage: COM.COMInterop<CWinRT.SWRT_WindowsUIXamlControls_IWrapGridStatics>? = nil

    internal static var _iwrapGridStatics: COM.COMInterop<CWinRT.SWRT_WindowsUIXamlControls_IWrapGridStatics> {
        get throws {
            try _iwrapGridStatics_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Controls.WrapGrid", id: CWinRT.SWRT_WindowsUIXamlControls_IWrapGridStatics.iid)
            }
        }
    }
}