...
public final class WindowsUIXamlAutomationPeers_PivotItemDataAutomationPeer: WindowsRuntime.WinRTImport<WindowsUIXamlAutomationPeers_PivotItemDataAutomationPeerProjection>, WindowsUIXamlAutomationProvider_IScrollItemProviderProtocol, WindowsUIXamlAutomationProvider_ISelectionItemProviderProtocol, WindowsUIXamlAutomationProvider_IVirtualizedItemProviderProtocol {
    // MARK: Windows.UI.Xaml.Automation.Peers.IPivotItemDataAutomationPeerFactory members

    public convenience init(_ item: WindowsRuntime.IInspectable?, _ parent: WindowsUIXamlAutomationPeers_PivotAutomationPeer?) throws {
        self.init(_transferringRef: try COM.NullResult.unwrap(Self._ipivotItemDataAutomationPeerFactory.createInstanceWithParentAndItem(item, parent)))
    }
    ...
    private static var _ipivotItemDataAutomationPeerFactory_storage: COM.COMInterop<CWinRT.SWRT_WindowsUIXamlAutomationPeers_IPivotItemDataAutomationPeerFactory>? = nil

    internal static var _ipivotItemDataAutomationPeerFactory: COM.COMInterop<CWinRT.SWRT_WindowsUIXamlAutomationPeers_IPivotItemDataAutomationPeerFactory> {
        get throws {
            try _ipivotItemDataAutomationPeerFactory_storage.lazyInit {
                try WindowsRuntime.getActivationFactoryPointer(activatableId: "Windows.UI.Xaml.Automation.Peers.PivotItemDataAutomationPeer", id: CWinRT.SWRT_WindowsUIXamlAutomationPeers_IPivotItemDataAutomationPeerFactory.iid)
            }
        }
    }
}