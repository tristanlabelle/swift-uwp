...
public final class WindowsWebHttp_HttpGetInputStreamResult: WindowsRuntime.WinRTImport<WindowsWebHttp_HttpGetInputStreamResultProjection>, WindowsFoundation_IClosableProtocol, WindowsFoundation_IStringableProtocol {
    // MARK: Windows.Web.Http.IHttpGetInputStreamResult members
    ...
    /// - Returns: The request message that led to this HttpGetInputStreamResult.
    ...
    /// - Returns: **IInputStream** value of the HTTP response.
    public var value: WindowsStorageStreams_IInputStream {
        get throws {
